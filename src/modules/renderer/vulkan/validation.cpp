...
bool validation::checkValidationLayersSupport()
{
    uint32_t layerCount;
...
std::vector<const char*> validation::getRequiredExtension()
{
...
void validation::setupDebuggerMessenger(VkInstance instance)
{
